...
private:
   ...
   float physMax;                                    // according to mounting
   float physMin;                                     
   float physStart;                                  // start position
   float physPos;                                    // current position
...
public:
   ...
   virtual int setAngleRelative(float angle);
   virtual int setMountingRange(float physMin, float physMax, float physStart);
   
   // getter
   float getPhysMax(void) { return physMax; }
   float getPhysMin(void) { return physMin; }
   float getPhysStart(void) { return physStart; }
   float getPhysPos(void) { return physPos; }
